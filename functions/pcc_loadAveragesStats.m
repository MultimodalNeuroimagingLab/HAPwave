...
good_channels       = find(ismember(channels_table.type,{'SEEG'}) & ...
                           ismember(channels_table.status,'good'));
...
% find good sEEG channels
all_out.good_channels   = find(ismember(channels_table.type,{'SEEG'}) & ismember(channels_table.status,'good'));
all_out.bad_channels    = find(~ismember(channels_table.type,{'SEEG'}) | ~ismember(channels_table.status,'good'));
